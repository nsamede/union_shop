...
import 'package:union_shop/views/pages/collection_page.dart';
import 'package:union_shop/views/pages/collections_page.dart';
import 'package:union_shop/views/pages/home_screen.dart';
